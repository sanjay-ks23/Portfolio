...
import {
  ...
  Brain, Database, Network, Terminal, BookOpen, PenTool
} from 'lucide-react';
          ...
          {activePage === 'blogs' && (
            <div className="max-w-4xl mx-auto w-full flex-grow">
              ...
              <div className="space-y-12">
                {BLOGS.map((blog) => (
                  <article key={blog.id} className="border-b border-dashed border-current pb-8 group cursor-pointer">
            ...
            <div className="flex items-center justify-center h-full flex-grow">
              <div className="max-w-2xl w-full border-4 border-double border-current p-8 md:p-12 text-center bg-current/5">
                ...
                <p className="font-mono text-sm md:text-base opacity-80 mb-8 max-w-lg mx-auto">
                  Interested in collaborating on AI research or engineering robust ML systems?
